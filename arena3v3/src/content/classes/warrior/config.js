export const warriorClass = {
  ...
  spells: [
    ...
    { id: "warrior-slam", offensiveCooldown: { durationMs: 2400, label: "BURST" }, name: "Slam", aiRole: "bigDamage", visualStyle: "warrior", target: "enemy", school: "physical", interruptible: false, resourceCost: 32, resourceGain: 10, castMs: 850, cooldownMs: 5000, gcdMs: 1200, range: 62, aiStartRange: 34, effects: [{ kind: "damage", amount: 188 }] },
    { id: "warrior-charge", name: "Charge", aiRole: "gapClose", visualStyle: "warrior", target: "enemy", school: "physical", utility: true, resourceCost: 0, resourceGain: 20, castMs: 0, cooldownMs: 14000, gcdMs: 1200, range: 250, noHitRoll: true, effects: [{ kind: "gapClose", stopDistance: 48 }, { kind: "root", drCategory: null, durationMs: 1200, breakOnDamage: false }] },
    { id: "warrior-pummel", name: "Pummel", aiRole: "interrupt", visualStyle: "warrior", target: "enemy", school: "physical", utility: true, resourceCost: 0, castMs: 0, cooldownMs: 12000, gcdMs: 0, ignoreGcd: true, range: 70, noHitRoll: true, effects: [{ kind: "interrupt", durationMs: 3000 }] },
  ],
};
