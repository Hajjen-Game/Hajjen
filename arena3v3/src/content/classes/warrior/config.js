export const warriorClass = {
  ...
  spells: [
    ...
    { id: "warrior-slam", name: "Slam", aiRole: "bigDamage", visualStyle: "warrior", target: "enemy", school: "physical", resourceCost: 32, resourceGain: 10, castMs: 850, cooldownMs: 5000, gcdMs: 1200, range: 62, effects: [{ kind: "damage", amount: 188 }] },
